...
var express = require( "express" ),
    ...
    Make = require( "../../node_modules/makeapi/public/js/make-api.js" ),
...
module.exports = {
  start: function( options, callback ) {
    ...
    function startFakeAPI() {
      ...
      var app = express(),
          env = new habitat(),
          routes = require( "../../node_modules/makeapi/routes/make.js" )( Fake, env ),
          middleware = require( "../../node_modules/makeapi/lib/middleware.js" )( env );

      app.use( express.logger( "dev" ) );
      app.use( express.bodyParser() );
      app.use( express.static( require( "path" ).join( __dirname, "/node_modules/makeapi/public" ) ) );
