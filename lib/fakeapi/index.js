...
var express = require( "express" ),
    ...
    path = require( "path" ),
    Make = require( path.resolve( __dirname, "node_modules/makeapi/public/js/make-api.js" ) ),
...
module.exports = {
  start: function( options, callback ) {
    ...
    function startFakeAPI() {
      ...
      var app = express(),
          env = new habitat(),
          routes = require( path.resolve( __dirname, "node_modules/makeapi/routes/make.js" ) )( Fake, env ),
          middleware = require( path.resolve( __dirname, "node_modules/makeapi/lib/middleware.js" ) )( env );

      app.use( express.logger( "dev" ) );
      app.use( express.bodyParser() );
      app.use( express.static( path.resolve( __dirname, "node_modules/makeapi/public" ) ) ) );
    ...
    Fogin.start({
      ...
      logins: logins.concat( counterfeit.users.map( function( email ) {
        return {
          email: email,
